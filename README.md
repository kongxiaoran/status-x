...
docker build -t status-x:0.0.3 .
docker tag status-x:0.0.3 dockerhubbs.finchina.com/finchina-dev/status-x:0.0.3
docker push dockerhubbs.finchina.com/finchina-dev/status-x:0.0.3
